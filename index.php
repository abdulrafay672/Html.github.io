                ...
                <div class="text-white">
                    <div class="flex p-2  bg-gray-800">
                        <div class="flex py-3 px-2 items-center">
                            <p class="text-2xl text-green-500 font-semibold">ONLIINE <p class="ml-2 font-semibold italic">
                            TUTOR</p>
                        </div>
                    </div>
                    <div class="flex justify-center">
                        <div class="">
                            <img class="hidden h-24 w-24 rounded-full sm:block object-cover mr-2 border-4 border-green-400"
                                src="../imges/sir.jpg" alt="">
                            <p class="font-bold text-base  text-gray-400 pt-2 text-center w-24">Lutif  Ali Junajo</p>
                        </div>
                    </div>
                    <div>
                        <ul class="mt-6 leading-10">
                            ...
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500" 
                                    ...
                                    <i class="fas fa-restroom" style="font-size: large;">
                                    <span class="ml-4 "> Join classes</span>
                                </i>
                                </a>
                            </li>
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500" 
                                    ...
                                    <span class="ml-4">Class Schedule</span>
                                    </i>
                                </a>
                            </li>
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500" 
                                    href="./recorded_video.html">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                        viewBox="0 0 24 24" stroke="">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                                    ...
                                    <span class="ml-4">Recorded Video</span>
                                    </i>
                                </a>
                            </li>
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500" 
                                    href="./perrsonal_meeting.html">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                        viewBox="0 0 24 24" stroke="">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                                    </svg>
                                    <i class="fas fa-mind-share">
                                    <span class="ml-4">Personal Meeting</span>
                                </i>
                                </a>
                            </li>
                              <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500" 
                                    href="schedule_new_meetinng.html">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                        viewBox="0 0 24 24" stroke="">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                                    ...
                                    <span class="ml-4">Schedule new Meeting</span>
                                    </i>
                                </a>
                            </li>
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500" 
                                    href="./chat_teacher.html">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                        viewBox="0 0 24 24" stroke="">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                                    ...
                                    <span class="ml-4">Chat With teachers</span>
                                    </i>
                                </a>
                            </li>
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500" 
                                    ...
                                    <i class="fad fa-chalkboard-teacher">&nbsp;
                            ...
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500" 
                                    ...
                                    <span class="ml-4">programming</span>
                                    </i>
                                </a>
                            </li>
                            <li class="relative px-2 py-1 ">
                            ...
                            <li class="relative px-2 py-1" x-data="{ Open : false  }">
                                ...
                                <div x-show.transition="Open" style="display:none;">
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <i class="fas fa-bed">
                                                    <a href="./login.html"
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">login
                                                        </a>
                                                        </i>
                                                </div>
                                            </div>
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <i class="fas fa-calendar-plus" style="font-size: large;"></i>
                                                    <a href="./registr.html"
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">Create Account
                                                        </a>
                                                    </i>
                                                </div>
                                            </div>
                                            ...
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <a href="./forgetpassword.html"
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">Forget PassWord
                                                        </a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <i class="fad fa-exclamation-square">
                                                    <a href="#"
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">404
                                                        </a>
                                                    </i>
                                                </div>
                                            </div>
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <i class="fas fa-blanket">
                                                    <a href="#"
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">Blank
                                                        </a>
                                                        </i>
                                                </div>
                                            </div>
                                 ...
                                 <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer  bg-blue-500" 
                                    href="./index.html">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                        viewBox="0 0 24 24" stroke="">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <span class="ml-4 ">Creat Account</span>
                                    </i>
                                </a>
                            </li>
                            </li>
        ...
        <aside
            ...
            <div>
                <div class="text-white">
                    <div class="flex p-2  bg-gray-800">
                        <div class="flex py-3 px-2 items-center">
                            <p class="text-2xl text-green-500 font-semibold">ONLIINE</p> <p class="ml-2 font-semibold italic">
                            TUTOR</p>
                        </div>
                    </div>
                    <div>
                        <ul class="mt-6 leading-10">
                            ...
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500"
                                    ...
                                    <i class="fas fa-video">
                                    <span class="ml-4">Recorded Videos</span>
                                    </i>
                                </a>
                            </li>
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500"
                                    ...
                                    <i class="fas fa-mind-share">
                                    <span class="ml-4">Perrsonal Meeting</span>
                                </i>
                                </a>
                            </li>
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500"
                                    ...
                                    <i class="fab fa-buromobelexperte">
                                    <span class="ml-4">Schedule  New Meetinng</span>
                                    </i>
                                </a>
                            </li>
                            <li class="relative px-2 py-1 ">
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <!-- <i class=""> -->
                                                    <a href="./login.html"
                                                        class=" fas fa-bed w-full ml-2  text-sm font-semibold text-white hover:text-gray-800"> &nbsp; Login
                                                    <!-- </i>   -->
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <a href="./registr.html"
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800 fas fa-calendar-plus"> &nbsp;Create 
                                                        Account</a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <a href="./forgetpassword.html"
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">Forget
                                                        Password
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <a href="#"
                                                        class=" fad fa-exclamation-square w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">404
                                                        </a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <!-- <i class=""> -->
                                                    <a href=""
                                                        class="fas fa-blanket w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">&nbsp; Blank
                                                        </a>
                                                </div>
                                            </div>
                                        </li>
                            ...
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500"
                                    ...
                                    <span class="ml-4 fas fa-calendar-plus">&nbsp; Create Account</span>
                                </a>
                            </li>
                        </ul>
                    </div>
